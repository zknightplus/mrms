 ...
 *          return count;
 *        },
 *        // Call this to update the tracked events to the trackingUrl
 *        update: function() {
      ...
      function nodeLinkFn(childLinkFn, scope, linkNode, $rootElement, boundTranscludeFn) {
        ...
        if (controllerDirectives) {
          forEach(controllerDirectives, function(directive) {
            ...
            // Instead, we update the controllers for the element in a local hash and attach to .data
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
       ...
       *   {@link angular.equals} function. To update the value of the object for later comparison,
...
// Copied from:
// http://docs.closure-library.googlecode.com/github/closure_goog_string_string.js.source.html#line962
